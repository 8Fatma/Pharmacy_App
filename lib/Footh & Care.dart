...
class foothandcare extends StatefulWidget {
  const foothandcare({Key? key}) : super(key: key);

  @override
  State<foothandcare> createState() => _foothandcareState();
}

// ignore: camel_case_types
class _foothandcareState extends State<foothandcare> {
  @override
